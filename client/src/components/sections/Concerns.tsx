    ...
    <div className="flex flex-col items-center px-20 pt-6 pb-10 mt-5 w-full text-center bg-cyan-100 max-md:px-5 max-md:max-w-full">
      <div className="flex flex-col items-center w-full max-w-[1120px] max-md:max-w-full">
        <div className="flex flex-wrap gap-10 items-start ml-14 max-w-full text-4xl font-bold leading-snug text-[color:var(--,#019ADB)] w-[618px]">
          <div className="relative" data-svg-wrapper>
        ...
        <div className="w-[1120px] h-[187px] justify-between items-center inline-flex">
          <div className="px-6 py-[30px] bg-white rounded-[20px] border-4 border-[#d9d9d9] flex-col justify-start items-center gap-4 inline-flex">
            <div className="text-center text-[#0199db] text-[28px] font-bold font-['Noto Sans'] leading-[37px]">介護ニーズ拡大 & 人手不足</div>
            <div className="text-center text-[#333333] text-lg font-semibold font-['Noto Sans'] leading-[34px]">2025年・2040年問題に向け、<br/>効率化は急務。</div>
          </div>
          <div className="px-6 py-[30px] bg-white rounded-[20px] border-4 border-[#d9d9d9] flex-col justify-start items-start gap-4 inline-flex">
            <div className="text-center text-[#0199db] text-[28px] font-bold font-['Noto Sans'] leading-[37px]">大手システムの課題</div>
            <div className="text-center text-[#333333] text-lg font-semibold font-['Noto Sans'] leading-[34px]">加算管理やレセプト連動が中心で<br/>高コスト・操作が複雑。</div>
          </div>
          <div className="px-6 py-[30px] bg-white rounded-[20px] border-4 border-[#d9d9d9] flex-col justify-start items-center gap-[22px] inline-flex">
            <div className="text-center text-[#0199db] text-[28px] font-bold font-['Noto Sans'] leading-[37px]">膨大な文書作成</div>
            <div className="text-center text-[#333333] text-lg font-semibold font-['Noto Sans'] leading-[34px]">「文章をどう書くか」に現場は苦戦し、<br/>属人化・教育負担が増大。</div>
          </div>
        </div>
        <img
          loading="lazy"
